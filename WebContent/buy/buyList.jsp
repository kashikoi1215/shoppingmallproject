...
<c:set var="total" value="0"/>
	...
	<table>
		<tr><td width="150">주문번호</td>
			<td width="300">상품명</td>
			<td width="100">판매가격</td>
			<td width="50">수량</td>
			<td width="100">금액</td>
			<td width="100">배송상황</td></tr>
		<tr><td width="150">${buylist.getBuy_id() }</td>
			<td width="300"><img src="/shoppingmall/bookImage/${buylist.getBook_image() }"
								class="cartimage">${buylist.getBook_title() }</td>
			<td width="100"><fmt:formatNumber value="${buylist.getBuy_price() }" type="number"
								pattern="#,##0"/>원</td>
			...
			<td width="100">${buylist.getSanction() }</td></tr>
	</table>
